...
function generateSchemaMarkup(post) {
  ...
  return `
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.hozanaconcept.com/blog.html"
      }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "position": 1,
        "name": "Accueil",
        "item": "https://www.hozanaconcept.com/index.html"
      },{
        "@type": "ListItem",
        "position": 2,
        "name": "Blog",
        "item": "https://www.hozanaconcept.com/blog.html"
      },{
        "@type": "ListItem",
        "position": 3,
...
function enhanceMetaTags(post) {
  ...
  const url = `https://www.hozanaconcept.com/article.html?id=${post.id}`;
  const date = new Date(post.publish_date || post.created_at).toISOString();
...
function initBlogSEO() {
  ...
  if (window.location.pathname.includes('blog.html') || window.location.pathname.includes('article.html')) {
    ...
    if (window.location.pathname.includes('blog.html')) {
      const schema = `
        <script type="application/ld+json">
        {
          ...
          "url": "https://www.hozanaconcept.com/blog.html",
          "publisher": {
            "@type": "Organization",
            "name": "Hozana Concept",
            "logo": {
